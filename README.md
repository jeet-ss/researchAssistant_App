...
| 🔌 |  **Integrations**  | <ul><li>The project integrates with language learning models (LLM) from either OpenAI or Google.</li><li>It also supports the Tavily search tool for web searching.</li><li>User interface elements are managed using `streamlit`, a Python library for data apps.</li></ul> |
...
| 🧪 |  **Testing**  | <ul><li>Testing commands are provided in the documentation, suggesting the presence of a testing framework.</li><li>However, specific details about the testing strategy or the coverage are not provided in the context details.</li></ul> |
...
Run ResearchAssistant App using the following command:

**Using `streamlit`**  &nbsp;  [<img align="center" src="https://img.shields.io/badge/Streamlit-3776AB.svg?style={badge_style}&logo=streamlit&logoColor=white" />](https://pypi.org/project/pip/)
...
-  [X]  **`Task 1`**: <strike>Implement Interview Agents.</strike>
...
This project is protected under the [GNU GENERAL PUBLIC LICENSE](https://github.com/jeet-ss/researchAssistant_App/blob/main/LICENSE.txt) License. For more details, refer to the [LICENSE](https://github.com/jeet-ss/researchAssistant_App/blob/main/LICENSE.txt) file.
